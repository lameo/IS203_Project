...
public class HeatMapDAO {
    ...
    /**
     * Returns a map of all the rooms in the floor specified with key of the
     * name of the semanticPlace and a value containing a heatmap object of said
     * place
     *
     * @param endtimeDate String in dd/mm/yyyy hh:mm format for where it
     * searches 15min before
     * @param floor String floor number where the map will be generated
     * @return Map with a String key containing the semanticPlace name and a
     * value containing a heatmap object of said place
     */
    ...
    /**
     * Return the total number of student present at the location (only using
     * the latest timestamp to avoid duplicate)
     *
     * @param semanticPlace String location name where the it searches for qty
     * of student
     * @param timeDate String in dd/mm/yyyy hh:mm format for where it searches
     * 15min before
